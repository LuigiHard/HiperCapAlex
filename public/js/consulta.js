...
function renderDezenasSection(
  ...
  val.textContent = Number(tituloNumero).toLocaleString('pt-BR');
  ...
  for (const [produto, cupons] of Object.entries(data)) {
    ...
    for (const c of sortedCupons) {
      ...
      summary.innerHTML = `
        ...
        <div class="summary-col"><span>Nº do Título</span><span>${Number(numeroCupom).toLocaleString('pt-BR')}</span></div>
